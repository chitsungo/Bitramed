...
import { adminPath, ADMIN_BASE } from "@/lib/routes";

const nav = [
  [adminPath(), "Overview", LayoutDashboard],
  [adminPath("learners"), "Learners", Users],
  [adminPath("access"), "Access", KeyRound],
  [adminPath("analytics"), "Analytics", BarChart3],
  [adminPath("activity"), "Activity", Activity],
] as const;
